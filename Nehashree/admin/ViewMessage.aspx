<%@ Page Title="" Language="C#" MasterPageFile="~/admin/AdminMaster.Master" AutoEventWireup="true" CodeBehind="ViewMessage.aspx.cs" Inherits="Nehashree.admin.ViewMessage" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
     <form id="form1" runat="server"> 

          <div class="container" style="border:double;height:700px;width:1100px;margin-left:100px;margin-top:100px">
            ...
            <div class="col-lg-6" style="float:right;height:600px">
                <div style="position: absolute; width: 400px; height:500px;margin-left:30px;margin-top:50px;border:ridge">
                    <asp:Label ID="lblshow" runat="server" Text="Messages"  Enabled="False" Font-Bold="True" Font-Names="Georgia" Font-Size="Medium"></asp:Label>
                </div>
            </div>
            <!-- display data -->
